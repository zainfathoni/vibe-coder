...
export function IdeasPage() {
  ...
  return (
    <div>
      ...
      {/* Search and Filters */}
      <div className="mb-6 p-4 border-4 border-retro-dark bg-white shadow-retro">
        <div className="mb-4">
          <input
            type="text"
            ...
            className="w-full font-retro text-xl px-3 py-2 border-4 border-retro-dark bg-retro-cream focus:outline-none focus:border-retro-purple"
          />
        </div>
        <div className="flex flex-wrap gap-4">
          <div className="flex-1 min-w-[150px]">
            <label className="font-retro text-lg text-retro-navy block mb-1">Tech Stack</label>
            <select
              value={stackFilter}
          ...
          <div className="flex-1 min-w-[150px]">
            <label className="font-retro text-lg text-retro-navy block mb-1">Time Estimate</label>
            <select
              value={timeFilter}
        ...
        {hasFilters && (
          <button
            ...
            className="mt-4 font-retro text-lg text-retro-pink hover:text-retro-purple transition-colors"
          >
            ✕ Clear filters
          </button>
        )}
      ...
      {ideas.length === 0 && (
        <div className="text-center py-12 border-4 border-retro-dark bg-white shadow-retro">
          ...
          {hasFilters && (
            <button
              onClick={handleClearFilters}
              className="mt-4 font-retro text-xl text-retro-purple hover:text-retro-pink transition-colors"
            >
              Clear filters
            </button>
          )}
